         ...
         <div id="left">
            ...
            <!-- 内容列表 -->
               <?php if(is_array($data)): foreach($data as $key=>$report): ?><div class="list">
                     <div class="listhead">
                        <div class="title"><img src="__PUBLIC__/Images/arrow_go.png" alt="" /><a href="<?php echo U(Group_name.'/Index/Report/show');?>?id=<?php echo ($report["id"]); ?>"><?php echo ($report["title"]); ?></a></div>
