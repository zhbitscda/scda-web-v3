...
<title>就业指导</title>
<link rel="stylesheet" href="__PUBLIC__/Css/Direct/layout.css" type="text/css" />
...
<div class="wrapper">
   ...
   <div id="header">
      <div class="fl_left"><h1><a href="#"><strong>就业</strong>指导</a></h1></div>
...
<div class="wrapper">
   <div class=container>
      ...
      <div class="content">
         <div id="left">
            <div class="place"><img src="__PUBLIC__/Images/home.png" />&nbsp;您当前的位置:北理珠大学生职业发展协会网站&nbsp;&gt;&nbsp;就业指导</div>
            <div class="inframe">
    
            <!-- 内容列表 -->
               <?php if(is_array($data)): foreach($data as $key=>$report): ?><div class="list">
                     <div class="listhead">
                        <div class="title"><img src="__PUBLIC__/Images/arrow_go.png" alt="" /><a href="<?php echo U(Group_name.'/Index/Direct/show');?>?id=<?php echo ($report["id"]); ?>"><?php echo ($report["title"]); ?></a></div>
