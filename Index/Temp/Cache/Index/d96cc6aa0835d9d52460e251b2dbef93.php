...
<div class="wrapper">
   <div class=container>
      ...
      <div class="content">
         <div id="left">
            <div class="place"><img src="__PUBLIC__/Images/home.png" />&nbsp;您当前的位置:北理珠大学生职业发展协会网站&nbsp;&gt;&nbsp;职业测评</div>
            <div class="inframe">
    
            <!-- 内容列表 -->
               <?php if(is_array($data)): foreach($data as $key=>$report): ?><div class="list">
                     <div class="listhead">
                        <div class="title"><img src="__PUBLIC__/Images/arrow_go.png" alt="" /><a href="<?php echo U(Group_name.'/Index/Assess/show');?>?id=<?php echo ($report["id"]); ?>"><?php echo ($report["title"]); ?></a></div>
