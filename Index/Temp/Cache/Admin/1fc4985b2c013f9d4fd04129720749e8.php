...
<script type="text/javascript">
    ...
    window.onload = function(){
        ...
        window.UEDITOR_CONFIG.imageUrl = "<?php echo U(GROUP_NAME.'/Report/upload');?>";            
...
<body>
    <form action="<?php echo U(GROUP_NAME.'/Report/addReportHandle');?>" method="post">
        <table class="table">
            <tr>
                <th colspan="2">调研报告发布</th>
            </tr>
            <tr>
