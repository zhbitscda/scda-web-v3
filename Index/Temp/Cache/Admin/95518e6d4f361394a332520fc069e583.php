...
<script type="text/javascript">
    ...
    window.onload = function(){
        ...
        window.UEDITOR_CONFIG.imageUrl = "<?php echo U(GROUP_NAME.'/Direct/upload');?>";            
...
<body>
    <form action="<?php echo U(GROUP_NAME.'/Direct/addDirectHandle');?>" method="post">
        <table class="table">
            <tr>
                <th colspan="2">就业指导发布</th>
            </tr>
            <tr>
