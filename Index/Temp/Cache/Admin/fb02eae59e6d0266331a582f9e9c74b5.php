        ...
        <?php if(is_array($report)): foreach($report as $key=>$v): ?><tr>
                ...
                <td width="13%">
                    <?php if(ACTION_NAME == "index" ): ?>[<a href=''>修改</a>]
                        [<a href="<?php echo U(GROUP_NAME . '/Report/toTrach',array('id' => $v['id'],'type' => 1));?>">删除</a>]
                    <?php else: ?>
                        [<a href="<?php echo U(GROUP_NAME . '/Report/toTrach',array('id' => $v['id'],'type' => 0));?>">还原</a>]
                        [<a href="<?php echo U(GROUP_NAME . '/Report/delete',array('id' => $v['id']));?>">彻底删除</a>]<?php endif; ?>
                </td>
