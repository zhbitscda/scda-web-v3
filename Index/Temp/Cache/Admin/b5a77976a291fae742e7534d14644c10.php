...
<script type="text/javascript">
    ...
    window.onload = function(){
        ...
        window.UEDITOR_CONFIG.imageUrl = "<?php echo U(GROUP_NAME.'/Visit/upload');?>";            
...
<body>
    <form action="<?php echo U(GROUP_NAME.'/Visit/addVisitHandle');?>" method="post">
        <table class="table">
            <tr>
                <th colspan="2">企业观光发布</th>
            </tr>
            <tr>
