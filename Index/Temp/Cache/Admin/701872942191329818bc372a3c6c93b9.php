...
<script type="text/javascript">
    ...
    window.onload = function(){
        ...
        window.UEDITOR_CONFIG.imageUrl = "<?php echo U(GROUP_NAME.'/Assess/upload');?>";            
...
<body>
    <form action="<?php echo U(GROUP_NAME.'/Assess/addAssessHandle');?>" method="post">
        <table class="table">
            <tr>
                <th colspan="2">职业测评发布</th>
            </tr>
            <tr>
