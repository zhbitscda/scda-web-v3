...
<link rel="stylesheet" href="css/news_details/layout.css" type="text/css" />
   ...
   <div id="topbar">
      <div id="topnav">
         <ul>
            ...
            <li class="active"><a href="{:U(GROUP_NAME . '/News/index')}">新闻动态</a></li>
      	    <li><a href="{:U(GROUP_NAME . '/Report/index')}">调研报告</a></li>
            <li><a href="{:U(GROUP_NAME . '/Direct/index')}">就业指导</a></li>
            <li><a href="{:U(GROUP_NAME . '/Visit/index')}">企业观光</a></li>
   ...
   <div class="container">
      ...
      <div class="content">
         ...
         <div class="place">
            ...
            <div class="s2">北理珠大学生职业发展协会网站&nbsp;&gt;&nbsp;新闻动态&nbsp;&gt;&nbsp;正文</div>
         </div>
         <!-----  upcontent  ----->
         <div class="upcontent">
            <!----- tittle ----->
